...
public class StarAndHexagon : MonoBehaviour
{
    ...
    // Корутина работает в нескольких кадрах, вместо одного как у Update.
    // 
    ...
    private IEnumerator Cr()
    {
        ...
        while (true)
        {
            ...
            if (ChangeRoute)
            {
                yield return MoveFromTo(transform.position, transform.position + new Vector3(-4f, 0f, 3f), Speed);
                yield return CreateMark();
                yield return new WaitForSeconds(AwaitingTime);
                yield return MoveFromTo(transform.position, transform.position + new Vector3(0f, 0f, 5f), Speed);
                yield return CreateMark();
                yield return new WaitForSeconds(AwaitingTime);
                yield return MoveFromTo(transform.position, transform.position + new Vector3(4f, 0f, 3f), Speed);
                yield return CreateMark();
            ...
            {
                yield return MoveFromTo(transform.position, transform.position + new Vector3(3f, 0f, 5f), Speed);
                yield return CreateMark();
                yield return new WaitForSeconds(AwaitingTime);
                yield return MoveFromTo(transform.position, transform.position + new Vector3(-5f, 0f, 3f), Speed);
                yield return CreateMark();
                yield return new WaitForSeconds(AwaitingTime);
                yield return MoveFromTo(transform.position, transform.position + new Vector3(5f, 0f, 0f), Speed);
                yield return CreateMark();
                yield return new WaitForSeconds(AwaitingTime);
                yield return MoveFromTo(transform.position, transform.position + new Vector3(2f, 0f, 5f), Speed);
                yield return CreateMark();
                yield return new WaitForSeconds(AwaitingTime);
                yield return MoveFromTo(transform.position, transform.position + new Vector3(2f, 0f, -5f), Speed);
                yield return CreateMark();
