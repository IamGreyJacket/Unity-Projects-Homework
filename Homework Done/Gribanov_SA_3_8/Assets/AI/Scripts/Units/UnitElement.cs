...
namespace AI.Units
{
	public class UnitElement : MonoBehaviour
	{
		...
		private void OnTriggerEnter(Collider other)
		{
			...
			_signal.FireId("Unit", new ActionResultInfo(_action, _parent, unit, success ? ActionResultType.Successfully : ActionResultType.Failed));//todo никогда не будет фейла потому что персонаж не попадает же. Метод не вызывается
