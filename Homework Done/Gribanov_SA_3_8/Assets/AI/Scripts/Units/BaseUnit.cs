...
namespace AI.Units
{
    public abstract class BaseUnit : MonoBehaviour
    {
        ...
        public UnitType GetUnitType => _unit;
        ...
        private void OnActionEnd_UnityEditor(string param)
        {
            InAnimation = false;
            //Оповещение о том, что анимация завершена
            _signal.FireId("Unit", new ActionResultInfo(param.Contains("IMPACT") ? ActionType.IMPACT : _currentActionType, this, null, ActionResultType.Completed));//todo не удачное решение об оповещении по импакту
        }
		...
		protected void SetAnimationState(ActionType newType)
        {
            InAnimation = true;
